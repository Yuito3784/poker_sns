    ...
    >
      <div className="mb-3 flex items-center gap-2">
        ...
        <div className="space-y-1.5">
          ...
          <div className="h-2.5 w-16 rounded" style={{ background: "#1f2a1e" }} />
        </div>
      </div>
      <div className="ml-11 space-y-2">
        <div className="h-3.5 w-full rounded" style={{ background: "#1f2a1e" }} />
        <div className="h-3.5 w-4/5 rounded" style={{ background: "#1f2a1e" }} />
        <div className="h-3.5 w-3/5 rounded" style={{ background: "#1f2a1e" }} />
      </div>
      <div className="ml-11 mt-3 flex gap-3">
        <div className="h-5 w-10 rounded" style={{ background: "#1f2a1e" }} />
        <div className="h-5 w-10 rounded" style={{ background: "#1f2a1e" }} />
        <div className="h-5 w-10 rounded" style={{ background: "#1f2a1e" }} />
      </div>
    </li>
