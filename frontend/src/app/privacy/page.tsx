  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        <h1 className="mb-8 text-2xl font-bold tracking-tight">プライバシーポリシー</h1>

        <div className="space-y-6 text-sm leading-relaxed text-neutral-700">
          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">1. 収集する情報</h2>
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">2. 情報の利用目的</h2>
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">3. 情報の第三者提供</h2>
            <p>法令に基づく場合を除き、ユーザーの同意なく個人情報を第三者に提供することはありません。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">4. パスワードの保護</h2>
            <p>パスワードはbcryptにより暗号化して保存しており、平文での保存は行いません。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">5. Cookie・トークン</h2>
            <p>本サービスではJWTトークンをlocalStorageに保存して認証を行います。トークンは有効期限付きで自動的に更新されます。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">6. データの削除</h2>
            <p>ユーザーは設定ページからアカウントを削除できます。アカウント削除時に、投稿・フォロー関係・通知等の全データが完全に削除されます。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">7. ポリシーの変更</h2>
            <p>本ポリシーは予告なく変更されることがあります。変更後のポリシーは本ページに掲載した時点で効力を生じます。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-neutral-900">8. お問い合わせ</h2>
