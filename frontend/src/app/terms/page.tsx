    ...
    <div className="min-h-screen bg-[#0d1009] text-[#ddd6c8]">
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-[#9a8e7a]">
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-[#ddd6c8]">第2条（アカウント登録）</h2>
            <p>ユーザーは正確な情報を提供してアカウントを登録するものとします。アカウント情報の管理はユーザー自身の責任で行ってください。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-[#ddd6c8]">第3条（禁止事項）</h2>
            <p>以下の行為を禁止します。</p>
          ...
          <section>
            <h2 className="mb-2 text-base font-semibold text-[#ddd6c8]">第4条（投稿コンテンツ）</h2>
            <p>ユーザーが投稿したコンテンツの著作権はユーザーに帰属します。ただし、本サービスの運営に必要な範囲で利用を許諾するものとします。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-[#ddd6c8]">第5条（サービスの変更・停止）</h2>
            <p>運営はユーザーへの事前通知なく、本サービスの内容を変更、または提供を停止することがあります。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-[#ddd6c8]">第6条（免責事項）</h2>
            <p>本サービスの利用により生じた損害について、運営は一切の責任を負いません。ポーカーに関する情報は教育目的であり、ギャンブルを推奨するものではありません。</p>
          </section>

          <section>
            <h2 className="mb-2 text-base font-semibold text-[#ddd6c8]">第7条（規約の変更）</h2>
